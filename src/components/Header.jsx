          ...
          <div className="header__logo">
            <Link to="/">
              <div className='header__logo-icon'>
                <img src="/img/logo.svg" alt="REACT SNEAKERS" />
              </div>
              <div className="header__logo-text text-logo">
                <h3 className='text-logo__label'>REACT SNEAKERS</h3>
                <p className="text-logo__subtitle">Магазин лучших кроссовок</p>
              </div>
            </Link>
          </div>
          <nav className="header__nav">
            <ul className="header__list">
              <li className="header__item">
                <button className="header__item-button" onClick={props.onClickCart}>
                  ...
                  <p className="cost">{totalPrice === 0 ? null : totalPrice + ' руб.'}</p>
                </button>
              </li>
              <li className="header__item">
                <Link to="/favorites">
                  <button className="header__item-button">
